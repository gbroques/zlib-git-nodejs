...
/**
 * 40-digit hexadecimal SHA-1 object hash.
 *
 * For example,
 *
...
const objectDatabasePath = path.join('.git', 'objects');
const objectPath = path.join(objectDatabasePath, objectDirectory, objectFilename);
